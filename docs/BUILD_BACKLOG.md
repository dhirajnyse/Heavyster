# Heavyster Build Backlog

## Sprint 1: Public Prototype
...
- Supplier Success Daily Queue for ranking all suppliers by save urgency, lead ROI, proof gaps, renewal risk, and expansion ARR
...
- Decide production stack
- Add routing and component structure
- Add data fixtures
- Add static tests
- Add deployment workflow
- Add GitHub issue templates

## Sprint 3: Supplier MVP
...
- Daily supplier success worklist before expansion pushes
